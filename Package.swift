...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "MacrosForStroblMocks", dependencies: ["MacrosForStroblMocksMacros"]),

        // A client of the library, which is able to use the macro in its own code.
        .executableTarget(name: "MacrosForStroblMocksClient", dependencies: ["MacrosForStroblMocks"]),
