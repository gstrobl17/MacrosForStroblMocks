...
public class NonCustomReflectableMock: CookieStoring {
...
extension NonCustomReflectableMock.Method: CustomStringConvertible {
...
extension NonCustomReflectableMock.MethodParameter: CustomStringConvertible {
    public var description: String {
        var value = "["
        var first = true
        func handleFirst() {
